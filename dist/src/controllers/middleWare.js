...
const secureRoute = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        throw new AppError_1.default("Invalid API key", errorController_1.UNAUTHORIZED.code, error);
    }
    ...
    if (!user)
        throw new AppError_1.default("Not a user", errorController_1.UNAUTHORIZED.code);
